defmodule FlameTalkWeb.CoreComponents.SwiftUI do
  @moduledoc """
  ...
  of the `FlameTalkWeb.CoreComponents` functions you should expect identical functionality for similarly named
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FlameTalkWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FlameTalkWeb.Gettext, "errors", msg, opts)
    end
  end

defmodule FlameTalkNative do
  ...
  import FlameTalkWeb, only: [verified_routes: 0]
  ...
  def live_view() do
    quote do
      use LiveViewNative.LiveView,
        ...
        layouts: [
          swiftui: {FlameTalkWeb.Layouts.SwiftUI, :app}
        ]
  ...
  defp helpers(format) do
    ...
    core_component_module = Module.concat([FlameTalkWeb, CoreComponents, plugin.module_suffix])
